...
#define ENC_BTNB             -1       //  Кнопка энкодера-2 (Key, SW)
...
/*  BUTTONS  */
#define BTN_LEFT              -1           //  VolDown, Prev
#define BTN_CENTER            -1           //  Play, Stop, Show playlist
#define BTN_RIGHT             -1           //  VolUp, Next
#define BTN_UP                -1        //  Prev, Move Up
#define BTN_DOWN              -1        //  Next, Move Down
...
//#define BTN_MODE              -1            // Перемикач РЕЖИМУ
