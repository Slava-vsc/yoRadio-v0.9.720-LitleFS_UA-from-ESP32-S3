...
const ScrollConfig metaConf       PROGMEM = {{ TFT_FRAMEWDT, TFT_FRAMEWDT, 3, WA_LEFT }, 140, true, MAX_WIDTH, 5000, 4, 30 };
...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 96, 2, WA_LEFT }, 140, true, MAX_WIDTH, 0, 3, 30 };

/* BACKGROUNDS  */                       /* {{ left, top, fontsize, align }, width, height, outlined } */
const FillConfig   metaBGConf     PROGMEM = {{ 0, 32, 0, WA_LEFT }, DSP_WIDTH, 1, false };
...
const WidgetConfig bootstrConf    PROGMEM = { TFT_FRAMEWDT, 182, 2, WA_CENTER };
const WidgetConfig bitrateConf    PROGMEM = { 70, 191, 1, WA_LEFT };
const WidgetConfig voltxtConf     PROGMEM = { TFT_FRAMEWDT, 220, 2, WA_LEFT };
const WidgetConfig  iptxtConf     PROGMEM = { TFT_FRAMEWDT, 220, 2, WA_CENTER };
const WidgetConfig   rssiConf     PROGMEM = { TFT_FRAMEWDT, 220, 2, WA_RIGHT };
const WidgetConfig numConf        PROGMEM = { TFT_FRAMEWDT, 120+30, 0, WA_CENTER };
...
const WidgetConfig  clockConf     PROGMEM = { TFT_FRAMEWDT, 176, 0, WA_RIGHT };
const WidgetConfig vuConf         PROGMEM = { TFT_FRAMEWDT, 100, 1, WA_LEFT };

const WidgetConfig bootWdtConf    PROGMEM = { TFT_FRAMEWDT, 162, 1, WA_CENTER };
const ProgressConfig bootPrgConf  PROGMEM = { 90, 14, 4 };
const BitrateConfig fullbitrateConf PROGMEM = {{DSP_WIDTH-TFT_FRAMEWDT-40, 43, 2, WA_LEFT}, 42 };
...
const MoveConfig    clockMove     PROGMEM = { TFT_FRAMEWDT, 180, -1 };
const MoveConfig   weatherMove    PROGMEM = { TFT_FRAMEWDT, 96, MAX_WIDTH };
const MoveConfig   weatherMoveVU  PROGMEM = { 70, 96, MAX_WIDTH-70+TFT_FRAMEWDT };
