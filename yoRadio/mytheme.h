...
#define COLOR_STATION_NAME		210, 210, 100    /*  колір шрифту назви станції                */
...
#define COLOR_CLOCK             255, 220,   0    /*  колір шрифту годинника                    */
#define COLOR_CLOCK_BG            5,   5,   5    /*  колір фону годинника                      */
#define COLOR_SECONDS			255, 220,   0    /*  колір шрифту секунд                       */
#define COLOR_NAMEDAY           231, 211,  90	 /*  колір шрифту імен для іменин              */
#define COLOR_DAY_OF_W          255, 100,  10    /*  колір шрифту дня тижня                    */
#define COLOR_DATE              255, 100,  10    /*  колір шрифту дати                         */
