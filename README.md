# yoRadio-v0.9.720-LitleFS з Українською локалізацією, оновленими аудіо-бібліотеками для ESP32-S3.
<img src="images/yologo.png" width="190" height="142">

Мод створений на основі [ёRadio](https://github.com/e2002/yoradio),

з використанням аудіо-бібліотек audioI2S [Вихідників від Wolle (schreibfaul1) Version 3.4.2p від 13.09.2025](https://github.com/schreibfaul1/ESP32-audioI2S/),  [адаптованих Maleksm](https://4pda.to/forum/index.php?showtopic=1010378&view=findpost&p=125839228)

Оновлений MOD yoRadio з новими форматами для I2S та vs1053b.
Тепер грають формати M3U8 та OGG, кодеки VORBIS, на I2S грають OPUS та FLAC.
